...
func schema_kubernetes_operator_api_operator_v1alpha1_DaprControlPlane(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/dapr/kubernetes-operator/api/operator/v1alpha1.DaprControlPlaneSpec", "github.com/dapr/kubernetes-operator/api/operator/v1alpha1.DaprControlPlaneStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_kubernetes_operator_api_operator_v1alpha1_DaprControlPlaneList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/dapr/kubernetes-operator/api/operator/v1alpha1.DaprControlPlane", v1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_kubernetes_operator_api_operator_v1alpha1_DaprControlPlaneStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/dapr/kubernetes-operator/api/operator/v1alpha1.ChartMeta", v1.Condition{}.OpenAPIModelName()},
	}
}
...
func schema_kubernetes_operator_api_operator_v1alpha1_DaprCruiseControl(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/dapr/kubernetes-operator/api/operator/v1alpha1.DaprCruiseControlSpec", "github.com/dapr/kubernetes-operator/api/operator/v1alpha1.DaprCruiseControlStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_kubernetes_operator_api_operator_v1alpha1_DaprCruiseControlList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "DaprCruiseControlList contains a list of DaprCruiseControl.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/dapr/kubernetes-operator/api/operator/v1alpha1.DaprCruiseControl", v1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_kubernetes_operator_api_operator_v1alpha1_DaprInstance(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/dapr/kubernetes-operator/api/operator/v1alpha1.DaprInstanceSpec", "github.com/dapr/kubernetes-operator/api/operator/v1alpha1.DaprInstanceStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_kubernetes_operator_api_operator_v1alpha1_DaprInstanceList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "DaprInstanceList contains a list of DaprInstance.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/dapr/kubernetes-operator/api/operator/v1alpha1.DaprInstance", v1.ListMeta{}.OpenAPIModelName()},
	}
}
